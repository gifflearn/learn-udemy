...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.searchPokemons = function (term) {
        ...
        return this.http.get(this.pokemonsUrl + "/?name=" + term).pipe(operators_1.tap(function (_) { return _this.log('found polemons matching "${term}"'); }), operators_1.catchError(this.handleError('searchPokemons', [])));
    };
    PokemonsService.prototype.deletePokemon = function (pokemon) {
        ...
        return this.http.delete(this.pokemonsUrl, httpOptions).pipe(operators_1.tap(function (_) { return _this.log('deleted pokemon id=${pokemon.id}'); }), operators_1.catchError(this.handleError('deletePokemon')));
    };
