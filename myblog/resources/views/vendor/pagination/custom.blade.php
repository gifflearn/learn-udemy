@if($paginator->hasPages())
    <ul class="pagination">
        ...
        @else
            <li class="page-item">
                <a href="{{ $paginator->previousPageUrl()}}" rel="prev" class="page-link"><i class="fas fa-arrow-left"></i></a>
            </li>
        @endif
        ...
        @if ($paginator->hasMorePages())
            <li class="page-item">
                <a href="{{ $paginator->nextPageUrl()}}" rel="next" class="page-link"><i class="fas fa-arrow-right"></i></a>
            </li>
        @else
